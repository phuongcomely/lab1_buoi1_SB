...
let score = 0;
let yourAnswers = []; //mảng câu tl của người dùng
let questionsStatus = questions.map((question, index) => { //hàm duyệt câu hỏi
...
const renderQuestion = () => {
    const currentQuestion = questions[currentQuestionIndex]; //lấy từng câu hỏi có trong mảng question theo vị trí câu hỏi truyền vào 
...
// tạo ra có bộ số câu hỏi hiển thị lên màn hình 
...
//sử dụng cho sự kiện chọn câu hỏi bất kì trong bộ các câu hỏi 

const renderQuestionWithQuestionNumber = (questionNumber) => {
    currentQuestionIndex = questionNumber;
    renderQuestion();
};
//=============== sự kiện cho btn Next===========
